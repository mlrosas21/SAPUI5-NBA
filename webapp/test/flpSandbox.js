		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Roster NBA",
									"targetURL": "#academia2022znba-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"academia2022znba-display": {
								"semanticObject": "academia2022znba",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=academia2022.znba",
									"url": sap.ui.require.toUrl("academia2022/znba")
								}
							}
						}
					}
